...
/** Incomplete inbound framing/header block, excluding an application-owned DATA pause. */
int chttp_h2_proto_input_incomplete(const chttp_h2_proto *p);
/** Monotonic counter of completed inbound frame/header-block boundaries. */
uint64_t chttp_h2_proto_input_generation(const chttp_h2_proto *p);
